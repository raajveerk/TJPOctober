...
// Function to calculate Net Profit & Profit Percentage for the trade type - 'SELL'

// function profitcalcSell() {
//   value = document.getElementById("buyprice2").value;
//   console.log("This works as well")
//   console.log(value)
//   var x = document.getElementById("sellprice2").value;
...
//   }
//   console.log(profit_percent);
//   console.log("This works 520")
//   document.getElementById("profit").value = profit;
//   console.log("This works 620")
//   document.getElementById("profitpercent").value = profit_percent;
//   console.log("This works 720")
  
// }

// function profitcalc(userValue) {
...
//     profit = (userValue - x)*y;
//     console.log(profit);
//     var profit_percent = 0;
//     profit_percent =((userValue-x)/x)*100;
//     console.log(profit_percent);
//     console.log("This works 7999")
//     document.getElementById("profit").value = profit;
//     console.log("This works 8999")
...
//     console.log("This works")
//     console.log(userValue)
//     var x = document.getElementById("sellprice").value;
//     console.log(x)
//     var y = document.getElementById("quantity").value;
//     console.log(y)
//     console.log("This works 6999")
...
//     profit = (x - userValue)*y;
//     console.log(profit);
//     var profit_percent = 0;
//     profit_percent =((x - userValue)/x)*100;
//     console.log(profit_percent);
//     console.log("This works 7999")
//     document.getElementById("profit").value = profit;
//     console.log("This works 8999")
